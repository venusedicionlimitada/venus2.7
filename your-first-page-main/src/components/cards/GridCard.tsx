...
export function GridCard({ item, idx, themeClasses, linkTo, linkParams, tagLabel }: GridCardProps) {
  ...
  const shell = `group flex flex-col border pt-5 px-5 sm:px-8 pb-8 transition-colors overflow-hidden relative w-full min-h-[320px] sm:min-h-[380px] md:min-h-[300px] block ${themeClasses}`;
  const body = (
    <>
